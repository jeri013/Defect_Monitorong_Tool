...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		if (window.addEventListener) {
			...
			window.addEventListener("load", function(){makeCollapsible(document.getElementById('listCategories2'), 1);}, false);
		} else if (window.attachEvent) {
			window.attachEvent("onload", function(){makeCollapsible(document.getElementById('listCategories'), 1);});
			window.attachEvent("onload", function(){makeCollapsible(document.getElementById('listCategories2'), 1);});
		} else {
			window.onload = function(){makeCollapsible(document.getElementById('listCategories'), 0);};
			window.onload = function(){makeCollapsible(document.getElementById('listCategories2'), 0);};
		} 
		-->
